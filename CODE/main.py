...
def parse_args():
    ...
    parser.add_argument('--data', type=str, default='mydata4')
    parser.add_argument('--scalar-edge-weights', action='store_true', default=True)
    parser.add_argument('--fusion-type', type=str, default='gated_with_cnn')#gated_with_cnn
    ...
    parser.add_argument('--pooling', type=str, default='mean',choices=['mean', 'sum', 'max', 'attention'])
